...
cbar=plt.colorbar()
cbar.set_label(label='Field enhancement [ |E|\u00b2 / |E\u2070|\u00b2 ]',rotation=270, labelpad=15)
plt.xlabel('x [nm]')
plt.ylabel('y [nm]')
plt.xticks(np.linspace(-50,50,11),fontsize=9)
plt.yticks(np.linspace(-50,50,11),fontsize=9)
